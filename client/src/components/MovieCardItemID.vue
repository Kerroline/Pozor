    ...
    <div class="card__main">
      <div class="card__main__posters">
        <div class="card__main__posters_item">
          <img :src="postersArray[0]" alt="Movie poster" />
        </div>
      </div>
      ...
      <div class="card__sub__galleries">
        ...
        >
          <div class="card__sub__galleries__item__gallery">
            <img :src="gallery" alt="Movie poster" />
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async publishingMovie() {
      try {
        const response = await fetch(
          `${HOST_API_URL}/publishMyMovie/${this.movie.id}`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
    ...
    async canceledPublishMovie() {
      try {
        const response = await fetch(
          `${HOST_API_URL}/canceledPublishMyMovie/${this.movie.id}`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
    ...
    async restoreMovie() {
      try {
        const response = await fetch(
          `${HOST_API_URL}/restoreMyMovie/${this.movie.id}`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
    ...
    async deleteMovie(isTrashing) {
      ...
      try {
        const response = await fetch(
          `${HOST_API_URL}${endpoint}/${this.movie.id}`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
